...
const Footer = () => {
  return (
    <div className="w-full border-t max-w-7xl border-gray-700 min-h-44 flex flex-col items-center justify-between pt-4 px-4 sm:px-0">
      <div className="w-full sm:w-[90%]  flex flex-col items-center sm:items-stretch sm:flex-row">
        <div className="w-full sm:w-1/2 flex flex-col items-center sm:items-start text-center sm:text-left">
          <div className="flex flex-col sm:flex-row items-center">
            <div className="flex items-center">
              ...
              <h1 className="text-white ml-3 mr-4 font-medium">Rodgers Munene</h1>
            </div>
            <a href="mailto:munenerodgers72@gmail.com" className="text-gray-400 mt-2  sm:mt-0 sm:ml-8 text-sm md:text-base hover:text-white transition-colors">
              munenerodgers72@gmail.com
            </a>
          </div>
          <div className="mt-3 sm:mt-5">
            <p className="text-gray-400 text-sm md:text-base">
              Software Engineer building web, mobile, and backend products.
            </p>
          </div>
        </div>
        <div className="w-full sm:w-1/2 flex justify-center sm:justify-end mt-5 sm:mt-0">
          <div className="flex flex-col items-center sm:items-end">
            ...
            <div className="flex w-24 justify-between text-gray-200 mt-3 sm:mt-5">
              <a
      ...
      <div className="w-full flex justify-center mt-5 sm:mt-0">
        <p className="text-gray-300 mb-5 text-sm sm:text-base">
          © 2026 Rodgers Munene. All rights reserved.
        </p>
      </div>
    </div>
  );
